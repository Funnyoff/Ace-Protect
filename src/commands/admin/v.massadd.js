...
module.exports = {
    ...
    async execute(message, args, client, lang) {
        console.log(`${message.author.tag}, utilise la commande *massadd* sur |${message.guild.name}|`)
        let color;
        ...
        const commenco = new Discord.MessageEmbed()
            .setColor(color)
            .setDescription(`**<@${message.author.id}>** ${lang.MassAddMessage} **${role}** ${lang.MassAddMessageAdding}`)
            .setTimestamp()
            .setFooter(`${client.user.username} `, `${client.user.displayAvatarURL()}`);
